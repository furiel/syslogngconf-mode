...
(defconst syslogngconf-keywords-consts
  '(
...
(defconst syslogngconf-keywords-options
  '(
...
(defconst syslogngconf-keywords-functions
  '(
  ...
  (concat "\\<"
          (regexp-opt
           (syslogngconf-prepare-keywordlist-for-optimization
            syslogngconf-keywords-builtins)
           t)
          "\\>"))
...
(defconst syslogngconf-keywords-regexp-functions-optimized
  (concat "\\<"
          (regexp-opt
           (syslogngconf-prepare-keywordlist-for-optimization
            syslogngconf-keywords-functions)
           t)
          "\\>"))
